...
`purge-mechanism-absent` (`shared/api.ts:7492-7494`), each with an operator sentence of its own at `:7532`,
`:7540` and `:7553`, which the session History tab renders through `lcRefusalWord`
