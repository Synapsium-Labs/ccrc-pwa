...
`purge-mechanism-absent` (`shared/api.ts:7417-7419`), each with an operator sentence of its own at `:7457`,
`:7465` and `:7478`, which the session History tab renders through `lcRefusalWord`
