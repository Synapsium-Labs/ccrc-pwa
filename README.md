...
`purge-mechanism-absent` (`shared/api.ts:7452-7454`), each with an operator sentence of its own at `:7492`,
`:7500` and `:7513`, which the session History tab renders through `lcRefusalWord`
