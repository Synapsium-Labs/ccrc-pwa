...
`purge-mechanism-absent` (`shared/api.ts:7539-7541`), each with an operator sentence of its own at `:7579`,
`:7587` and `:7600`, which the session History tab renders through `lcRefusalWord`
