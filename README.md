...
`purge-mechanism-absent` (`shared/api.ts:7561-7563`), each with an operator sentence of its own at `:7601`,
`:7609` and `:7622`, which the session History tab renders through `lcRefusalWord`
