...
const s = (over: Partial<FleetSession>): FleetSession => ({
  ...
  workspace: null,
  name: null, status: 'idle', statusUpdatedAt: null, limits: null, dialogPending: false, model: null, effort: null, ultracode: false, branch: null, tasks: null, pr: null, archivedAt: null, version: null,
  ...over,
});
