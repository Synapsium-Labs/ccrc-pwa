...
| # | Criterion | Verdict | Evidence |
|---|---|---|---|
| 1 | **Dedicated design phase** before the first screen | PASS | `design/DIRECTION.md` ("Phosphor & Ink", user-endorsed), `tokens.css` (74 contrast pairs machine-verified — re-ran `node design/contrast-check.mjs` this pass: all pass), `design/mockup.html`. Every component file cites its DIRECTION treatment. |
