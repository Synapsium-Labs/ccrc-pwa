...
export class Bus extends EventEmitter {
  ...
  override on(event: SessionEventName, listener: (msg: unknown) => void): this;
  ...
  override off(event: SessionEventName, listener: (msg: unknown) => void): this;
