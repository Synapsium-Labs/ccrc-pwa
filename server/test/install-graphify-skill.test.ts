...
// The pinned package's own frontmatter, verbatim from `<pkg>/skill.md` at 0.9.9
// (read 2026-09-02). The description is the whole reason spec §1's artifact
// table credits this skill with reaching every session, so the fixture carries
...
// The BODY says both tokens too — the real package's does — so the guard is
// bound to the frontmatter description and cannot go green on a body mention.
