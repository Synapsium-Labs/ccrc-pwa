...
| 3 | W3 | `/settings`, `UpdateBanner`, release push once per tag, move controls DISABLED | server | — | **run 130 open, planned**; plan `d638c602` + re-points `08cecd10`, `733d295a`; dispatch at W2's merge refused `cap-daily` (24/24, a rolling 24 h window), retried when the oldest dispatch ages out |
