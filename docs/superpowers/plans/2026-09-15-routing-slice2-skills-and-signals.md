...
Issued by `POST /api/ledger/deviations` on 2026-09-15 (one block of five, D-2830..D-2834, and one more, D-2835, issued after the whole-branch review) and defined here in the same act. Every one records a defect in THIS PLAN's text or a ruling the controller made on a plan-mandated finding; the shipped tree is as the entries describe.
